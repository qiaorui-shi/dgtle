import './index.scss'
import { Swiper, Tabs, Search } from 'react-vant'
  ...
  const Header: React.FC = () => {
    return (
      <div className='header'>
        <Tabs align='start' color='#2d3f56'>
          <Tabs.TabPane title='首页'></Tabs.TabPane>
          <Tabs.TabPane title='视频'></Tabs.TabPane>
        </Tabs>
      </div>
    )
  }
      ...
      <div className='article-list'>
        <div className='article'>
          ...
          <div className='article-text'>
            《买回当初想要的东西》第二十四期: Nokia N97 mini 一代机皇mini版
            记得当初...
          </div>
          ...
          {imgList.map((item, index) => (
            <Swiper.Item key={index}>
              <img
                ...
                src={loadImg(`/assets/img/${item}.png`)}
              />
            </Swiper.Item>
          ))}
        </Swiper>
